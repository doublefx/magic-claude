...
| Sequential pipeline (plan -> code -> test -> review) | **`magic-claude:craft`** | Structured handoffs, proven workflow |
...
1. **Using teams for sequential work** - Use `magic-claude:craft` instead
