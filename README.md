...
| **Domain skills** | 42 skills: coding standards, backend patterns, TDD workflows, security checklists, craft quality pipeline per ecosystem | [FEATURES](docs/FEATURES.md) |
