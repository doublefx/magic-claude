...
**Key skills to know:**
- `proactive-orchestration` — Claude automatically orchestrates the full pipeline (DISCOVER -> PLAN -> PLAN CRITIC -> [UI DESIGN] -> TDD -> VERIFY -> REVIEW) for complex feature requests
